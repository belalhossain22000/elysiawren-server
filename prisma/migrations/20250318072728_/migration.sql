/*
  ...
  - Added the required column `discountRate` to the `Product` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "discountRate" TEXT NOT NULL,
